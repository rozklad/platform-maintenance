...
return [
	...
	*/
	...
	'description' => 'Maintenance mode enabler',
	...
	*/
	...
	{
		$settings->find('platform')->section('maintenance', function ($s) {
			$s->name = trans('sanatorium/maintenance::settings.title');

            $s->fieldset('maintenance', function ($f) {
                $f->name = trans('sanatorium/maintenance::settings.title');

                $f->field('mode', function ($f) {
                    $f->name   = trans('sanatorium/maintenance::settings.mode.label');
                    $f->info   = trans('sanatorium/maintenance::settings.mode.info');
                    $f->type   = 'radio';
                    $f->config = 'sanatorium-maintenance.mode';
                ...
                $f->field('admin_allowed', function ($f) {
                    $f->name   = trans('sanatorium/maintenance::settings.admin_allowed.label');
                    $f->info   = trans('sanatorium/maintenance::settings.admin_allowed.info');
                    $f->type   = 'radio';
                    $f->config = 'sanatorium-maintenance.admin_allowed';
                ...
                $f->field('allowed', function ($f) {
                    $f->name   = trans('sanatorium/maintenance::settings.allowed.label');
                    $f->info   = trans('sanatorium/maintenance::settings.allowed.info');
                    $f->type   = 'input';
                    $f->config = 'sanatorium-maintenance.allowed';
                });
            });
        });
	},
